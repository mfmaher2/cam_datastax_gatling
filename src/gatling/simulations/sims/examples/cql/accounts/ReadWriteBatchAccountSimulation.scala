...
class ReadWriteBatchAccountSimulation  extends BaseSimulation {
  ...
  val writeAccountScenario = scenario("AccountBatchWrite")
    .feed(writeFeed)
    .exec(accountActions.writeAcountOpcoBatch("FX"))
